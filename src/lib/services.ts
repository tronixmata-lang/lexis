...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  "civil-and-criminal-litigation": {
    "navLabel": "Civil And Criminal Litigation",
    "faq": "Lexis and Legis is a leading law firm in Nepal, offering professional legal services in commercial and civil law. Our team of skilled attorneys specializes in family law, foreign investment, and corporate law, providing services such as legal consultations, document drafting, and court representation.",
  ...
  "commercial-contracts": {
    "navLabel": "Commercial Contracts",
    "faq": "Lexis and Legis is a leading law firm in Nepal, offering professional legal services in commercial and civil law. Our team of skilled attorneys specializes in family law, foreign investment, and corporate law, providing services such as legal consultations, document drafting, and court representation.",
    "title": "Commercial Contracts",
    "subtitle": "Legally enforceable frameworks for business relationships",
    "description": "Commercial contracts are foundational instruments in the business world, providing a structured and legally enforceable framework for interactions between entities. They are not merely bureaucratic necessities but strategic tools that underpin operational stability and facilitate economic activity.",
    "body": [
  ...
  "aviation-law": {
    "navLabel": "Aviation Law",
    "faq": "Lexis and Legis is a leading law firm in Nepal, offering professional legal services in commercial and civil law. Our team of skilled attorneys specializes in family law, foreign investment, and corporate law, providing services such as legal consultations, document drafting, and court representation.",
    "title": "Aviation Law",
    "subtitle": "Regulatory and commercial aviation legal services in Nepal",
    "description": "We provide focused legal counsel in Aviation Law, assisting domestic and international clients in navigating Nepal's unique regulatory, commercial, and operational aviation landscape.",
    "body": [
  ...
  "capital-markets-and-securities-law": {
    "navLabel": "Capital Markets And Securities Law",
    "faq": "Lexis and Legis is a leading law firm in Nepal, offering professional legal services in commercial and civil law. Our team of skilled attorneys specializes in family law, foreign investment, and corporate law, providing services such as legal consultations, document drafting, and court representation.",
    "title": "Capital Markets and Securities Law",
    "subtitle": "SEBON compliance, IPOs, and securities transactions",
    "description": "Nepal's capital markets are regulated under the Securities Act, 2063 (2007) and overseen by the Securities Board of Nepal (SEBON). The sector is witnessing gradual liberalization, with growing participation from domestic and foreign investors, publicly listed companies, and market intermediaries.",
    "body": [
  ...
  "cyber-law": {
    ...
    "description": "We offer strategic legal advisory in Information Technology Law, helping businesses, startups, digital platforms, and international tech companies navigate Nepal's growing digital legal ecosystem.",
    "body": [
  ...
  "immigration-law": {
    "navLabel": "Immigration Law",
    "faq": "Lexis and Legis is a leading law firm in Nepal, offering professional legal services in commercial and civil law. Our team of skilled attorneys specializes in family law, foreign investment, and corporate law, providing services such as legal consultations, document drafting, and court representation.",
    "title": "Immigration Law",
    "subtitle": "Visas, work permits, and residency in Nepal",
    "description": "We offer reliable and efficient legal services in Immigration Law, assisting foreign nationals, multinational companies, NGOs, and diplomatic missions with all aspects of immigration compliance and residency in Nepal.",
    "body": [
  ...
  "tax-law": {
    ...
    "description": "Nepal's tax system is governed primarily by the Income Tax Act, 2002, the Value Added Tax Act, 1996, the Excise Duty Act, 2002, and other related legislation, administered by the Inland Revenue Department (IRD). Our tax law practice covers a broad spectrum of services.",
    "body": [],
    "services": [
  ...
  "legal-due-diligence": {
    "navLabel": "Legal Due Diligence",
    "faq": "Lexis and Legis is a leading law firm in Nepal, offering professional legal services in commercial and civil law. Our team of skilled attorneys specializes in family law, foreign investment, and corporate law, providing services such as legal consultations, document drafting, and court representation.",
    "title": "Legal Due Diligence",
    "subtitle": "Transaction support, risk assessment, and compliance reviews",
    "description": "We provide comprehensive legal due diligence for mergers, acquisitions, investments, and corporate transactions, identifying legal risks, regulatory compliance gaps, and contractual liabilities before you commit to a deal.",
    "body": [
  ...
  "sports-law": {
    ...
    "description": "As Nepal's sports sector continues to expand on both national and international platforms, our firm provides the legal foundation necessary to protect the rights, integrity, and commercial interests of all stakeholders involved.",
    "body": [
  ...
  "property-law": {
    ...
    "description": "In dealing with real estate transactions, land disputes, inheritance, or foreign investment in property, our team provides practical, timely, and legally sound solutions based on the latest developments in Nepalese law.",
    "body": [
